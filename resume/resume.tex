...
\item
	...
	\begin{itemize}
		%\resitem{Work on a new version release system for the next generation Bloomberg Terminal that offers a much more versatile platform for deploying new software.}
		%\resitem{Significantly enhance the developers experience of pushing new code to production by building efficient back-end service and solid front-end UI to facilitate the entire release management process.}
		...
		%\resitem{Improve developer experience of deploying software for the next generation Bloomberg terminal by work on a new version release system for the next generation Bloomberg Terminal that offers developers a significantly enhanced}
